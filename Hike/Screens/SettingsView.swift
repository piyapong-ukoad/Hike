...
//  Hike
//
//  Created by Piyapong Ukoad on 4/9/2567 BE.
//
    ...
    var body: some View {
        List {
            ...
            Section(
                ...
                CustomListRowView(rowLabel: "Developer", rowIcon: "ellipsis.curlybraces", rowContent: "Piyapong Ukoad", rowTintColor: .mint)
